...
import { idlFactory } from './centinela_frontend.did.js';
export { idlFactory } from './centinela_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CENTINELA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./centinela_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the centinela_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./centinela_frontend.did.js")._SERVICE>}
 */
export const centinela_frontend = createActor(canisterId);

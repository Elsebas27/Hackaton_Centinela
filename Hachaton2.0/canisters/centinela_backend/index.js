...
import { idlFactory } from './centinela_backend.did.js';
export { idlFactory } from './centinela_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CENTINELA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./centinela_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the centinela_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./centinela_backend.did.js")._SERVICE>}
 */
export const centinela_backend = createActor(canisterId);
